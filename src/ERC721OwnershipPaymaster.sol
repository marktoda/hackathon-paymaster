 ...
 */
contract ERC721OwnershipPaymaster is Ownable, BasePaymaster, ERC1155, ERC721 {
    ...
    constructor(IEntryPoint _entryPoint, address _owner, address _erc721Token) BasePaymaster(_entryPoint) {
        ...
        returns (bytes memory context, uint256 validationData)
    {
        ...
        require(erc721Token.balanceOf(account) > 0, "DepositPaymaster: account has no balance of ERC721 token");
