 ...
 */
contract ERC721OwnershipPaymaster is Ownable, BasePaymaster, ERC1155 {
    ...
    constructor(IEntryPoint _entryPoint, address _owner, address _requiredToken, uint256 _minBalance ) BasePaymaster(_entryPoint) {
        ...
        returns (bytes memory context, uint256 validationData)
    {
        ...
        require(IERC20(requiredToken).balanceOf(account) > minBalance, "DepositPaymaster: account balance of required token too low");
